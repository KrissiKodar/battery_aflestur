...
namespace SmartBatteryHack
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            ROMCsvFilename = @"ROMs/CSV_" + DateTimeNow + ".csv";
                                    ...
                                    switch (SubDataCode)
                                    {
                                        ...
                                        case 0x04: // read rom byte, read dataflash BQ3060
                                            ...
                                            if (Payload.Length > 2)
                                            {
                                                ...
                                                using (StreamWriter csvWriter = new StreamWriter(ROMCsvFilename, true))
                                                {
                                            ...
                                            break;
                                        case 0x05: // read rom block, read dataflash, BQ4050, BQ78350
                                            Util.UpdateTextBox(CommunicationTextBox, "[RX->] ROM BQ4050/78350 block data received", Packet);
                                            if (Payload.Length > 2)
                                            {
                                                string address = Util.ByteToHexString(Payload, 0, 2);
                                                string data = Util.ByteToHexString(Payload, 2, Payload.Length);
