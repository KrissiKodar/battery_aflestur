...
with open('measured_data_pkl_files\BQ4050_0x0036_dataflash.pkl', 'rb') as file:
...
with open('measured_data_pkl_files\BQ3060_0x2203_dataflash.pkl', 'rb') as file:
    # Load the dictionary from the file
    data_df = pickle.load(file)
...
with open('measured_data_pkl_files\BQ78350_0x0000_dataflash.pkl', 'rb') as file:
    # Load the dictionary from the file
    data_df = pickle.load(file)
